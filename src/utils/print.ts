 ...
 */
function formatMessageTypes(messageType): void {
  const types = {
    conversation: '💬 Texto',
 ...
 */
function formatMessageStubType(stubType): void {
 ...
 */
async function getSafeName(jid, sock): void {
 ...
 */
function createLogBoxForMessage(details): void {
 ...
 * @returns {string} El mensaje de log formateado en una caja.
 */
function createLogBoxForEvent(title, details): void {

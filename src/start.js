...
import MonitoringService from './services/MonitoringService.js'; // Importar MonitoringService
...
export const startBot = async () => {
  ...
  try {
    ...
    container.register('pluginLoader', PluginLoader, { dependencies: ['aiService', 'memoryService'], isSingleton: true });

...
export function xpRange(level, multiplier = global.AdminTK_multiplier || 1) {
    if (level < 0)
...
export function findLevel(xp, multiplier = global.AdminTK_multiplier || 1) {
    if (xp === Infinity)
        return Infinity;
    if (isNaN(xp))
        return NaN;
...
export function canLevelUp(level, xp, multiplier = global.AdminTK_multiplier || 1) {
    if (level < 0)
        return false;
    if (xp === Infinity)
        return true;
...
//# sourceMappingURL=levelling.js.map
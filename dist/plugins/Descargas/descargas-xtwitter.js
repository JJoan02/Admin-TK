...
const handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text)
        throw `Ejemplo: *${usedPrefix + command}* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw`;
    if (enviando)
        return;
    enviando = true;
    try {
...
//# sourceMappingURL=descargas-xtwitter.js.map
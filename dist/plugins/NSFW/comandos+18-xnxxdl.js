...
const handler = async (m, { conn, args, command, usedPrefix }) => {
    ...
    if (!args[0])
        throw `${mid.smshorny} ${usedPrefix + command} https://www.xnxx.com/video-14lcwbe8/rubia_novia_follada_en_cuarto_de_bano*`;
    try {
...
//# sourceMappingURL=comandos+18-xnxxdl.js.map
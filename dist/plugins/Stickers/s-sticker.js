...
let handler = async (m, { conn }) => {
    if (db.data.chats[m.chat].stickers) {
        ...
        if (/^animada|animado|contento|contenta|alegría|alegrarse|alegremonos|emocionado|emocionada|feliz$/i.test(m.text)) {
            ...
            await delay(3 * 3000);
            if (stiker)
                conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply: { showAdAttribution: false, title: gt, body: `😻 𝗦𝘂𝗽𝗲𝗿 𝗚𝗮𝘁𝗮𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽`, mediaType: 2, sourceUrl: accountsgb, thumbnail: gataImg } } }, { quoted: m });
        }
...
//# sourceMappingURL=s-sticker.js.map
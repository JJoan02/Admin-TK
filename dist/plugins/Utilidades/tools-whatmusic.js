...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    if (/video|audio/.test(mime)) {
        ...
        return conn.reply(m.chat, `🚩 Etiqueta un audio o video de poca duración con el comando *${usedPrefix + command}* para ver que música contiene.`, m);
};
...
//# sourceMappingURL=tools-whatmusic.js.map
...
exports.GIFBufferToVideoBuffer = async (image) => {
    ...
    child_process.exec(`ffmpeg -i ./Processes/${filename}.gif -movflags faststart -pix_fmt yuv420p -vf "scale=trunc(iw/2)*2:trunc(ih/2)*2" ./Processes/${filename}.mp4`);
    await sleep(4000);
...
//# sourceMappingURL=myfunc1.js.map
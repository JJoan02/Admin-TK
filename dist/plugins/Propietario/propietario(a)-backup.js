    ...
    try {
        ...
        if (option === 1) {
            ...
            if (!fs.existsSync(path))
                return await m.reply('⚠️ El archivo *creds.json* no existe.');
            ...
            if (!fs.existsSync(databaseFolder))
                return await m.reply('⚠️ La carpeta *database* no existe.');
            ...
            if (!fs.existsSync(jadibtsFolder))
                return await m.reply('⚠️ La carpeta *GataJadiBot* no existe.');
...
//# sourceMappingURL=propietario(a)-backup.js.map
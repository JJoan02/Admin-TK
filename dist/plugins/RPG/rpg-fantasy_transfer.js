...
> _Si deseas continuar con la transferencia, escriba *"Si"* respondiendo a este mensaje, de lo contrario escriba *"No"*_`;
    ...
    handler.before = async (m) => {
        let senderCharacter;
        if (!usuarioExistente || !usuarioExistente[m.sender]?.fantasy?.some(personaje => personaje.id === imageInfo.code))
            return;
...
//# sourceMappingURL=rpg-fantasy_transfer.js.map
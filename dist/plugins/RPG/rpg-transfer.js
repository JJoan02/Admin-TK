...
`.trim();
    ...
    if (!who)
        return m.reply(`${ag} *ETIQUETE AL USUARIO*`);
    if (!(who in global.db.data.users))
        return m.reply(`${fg}*EL USUARIO ${who} NO SE ENCUENTRA EN MI BASE DE DATOS*`);
    if (user[type] * 1 < count)
        return m.reply(`${fg}*NO TIENE SUFUCIENTE PARA REALIZAR LA TRANSFERENCIA DE ${type}*`);
...
//# sourceMappingURL=rpg-transfer.js.map
            ...
            switch (type) {
                case 'ayambakar':
                    if (user.ayam < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak ayam bakar\nAnda butuh 2 ayam dan 1 coal untuk memasak`, m);
                    break;
                case 'gulaiayam':
                    if (user.ayam < count * 2 || user.coal < 1 * count) {
                        user.ayam >= count * 1;
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak gulai ayam\nAnda butuh 2 ayam dan 1 coal untuk memasak`, m);
                    break;
                case 'rendang':
                    if (user.sapi < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak dimasak rendang\nAnda butuh 2 sapi dan 1 coal untuk memasak`, m);
                    break;
                case 'ayamgoreng':
                    if (user.ayam < count * 2 || user.coal < 1 * count) {
                        user.ayam >= count * 1;
                ...
                case 'oporayam':
                    if (user.lele < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak opor ayam\nAnda butuh 2 ayam dan 1 coal untuk memasak`, m);
                    break;
                case 'steak':
                    if (user.sapi < count * 2 || user.coal < 1 * count) {
                        user.sapi >= count * 1;
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak steak\nAnda butuh 2 sapi dan 1 coal untuk memasak`, m);
                    break;
                case 'babipanggang':
                    if (user.babi < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak babi panggang\nAnda butuh 2 babi dan 1 coal untuk memasak`, m);
                    break;
                case 'ikanbakar':
                ...
                case 'lelebakar':
                    if (user.lele < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak lele bakar\nAnda butuh 2 lele dan 1 coal untuk memasak`, m);
                    break;
                case 'nilabakar':
                    if (user.nila < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak nila bakar\nAnda butuh 2 nila dan 1 coal untuk memasak`, m);
                    break;
                case 'bawalbakar':
                    if (user.bawal < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak bawal bakar\nAnda butuh 2 bawal dan 1 coal untuk memasak`, m);
                    break;
                case 'udangbakar':
                    if (user.udang < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak udang bakar\nAnda butuh 2 udang dan 1 coal untuk memasak`, m);
                    break;
                case 'pausbakar':
                    if (user.paus < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak paus bakar\nAnda butuh 2 paus dan 1 coal untuk memasak`, m);
                    break;
                case 'kepitingbakar':
                    if (user.kepiting < count * 2 || user.coal < 1 * count) {
                        ...
                        conn.reply(m.chat, `Anda tidak memiliki bahan untuk memasak kepiting bakar\nAnda butuh 2 kepiting dan 1 coal untuk memasak`, m);
                    break;
                default:
                    ...
                    ], m, { mentions: conn.parseMention(cocinar) });
...
//# sourceMappingURL=rpg-cocinar.js.map
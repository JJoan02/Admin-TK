...
let handler = async (m, { conn, args, text, usedPrefix }) => {
    if (args.length < 3)
        return m.reply(`🔹 *Uso correcto:* ${usedPrefix}tweet @usuario comentario`);
    ...
    if (!userData || !userData.name)
        return m.reply(`⚠️ El usuario @${mentionedJid.split("@")[0]} no está registrado en la base de datos.`);
...
//# sourceMappingURL=fun-faketweet.js.map
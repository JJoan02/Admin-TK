const handler = async (m, { conn, args }) => {
    ...
    await conn.sendFile(m.chat, global.API('https://some-random-api.com', '/canvas/gay', { avatar: avatarUrl }), 'error.png', '*🏳️‍🌈 𝙼𝙸𝚁𝙴𝙽 𝙰 𝙴𝚂𝚃𝙴 𝙶𝙰𝚈 🏳️‍🌈*', m);
...
//# sourceMappingURL=fun-gay2.js.map
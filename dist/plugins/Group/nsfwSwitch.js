    ...
    start: async (Yaka, m, { args, isBotAdmin, isAdmin, isCreator, reply, prefix, pushName }) => {
        ...
        if (args[0] === "on") {
            if (!checkdata) {
                ...
                return Yaka.sendMessage(m.from, { text: `*NSFW* has been *Activated* in this group!` }, { quoted: m });
            }
            else {
                if (checkdata.switchNSFW == "true")
                    return Yaka.sendMessage(m.from, { text: `*NSFW* is already *Activated* in this group !` }, { quoted: m });
            ...
            if (!checkdata) {
                ...
                return Yaka.sendMessage(m.from, { text: `*NSFW* has been *De-Activated* in this group !` }, { quoted: m });
            }
            else {
                if (checkdata.switchNSFW == "false")
                    return Yaka.sendMessage(m.from, { text: `*NSFW* is already *De-Activated* in this group !` }, { quoted: m });
...
//# sourceMappingURL=nsfwSwitch.js.map
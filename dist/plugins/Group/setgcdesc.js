...
module.exports = {
    ...
    react: "👹",
    start: async (Yaka, m, { text, prefix, isBotAdmin, isAdmin, pushName, metadata, args, mime }) => {
        ...
        await Yaka.groupUpdateDescription(m.from, newGCdesc).then((res) => Yaka.sendMessage(m.from, {
            image: { url: ppgc, mimetype: "image/jpeg" },
            caption: `*『 Group Description Changed 』*\n\n_🧩 New Description:_\n*${args.join(" ")}*`,
        }, { quoted: m })).catch((err) => replay(jsonformat(err)));
    },
};
//# sourceMappingURL=setgcdesc.js.map
let handler = async (m, { conn, text, usedPrefix, command, participants }) => {
    ...
    if (!text || text.length == 1)
        return conn.reply(m.chat, `🚩 Ingresa la pregunta y opciones.\n\n*Ejemplo:*\n*${usedPrefix + command}*Ella te ama si o no?|si|no`, m, rcanal);
    if (text.length > 1 && text.length < 3)
        return m.reply(`Mínimo *2* opciones.`);
    if (text.length > 13)
        return m.reply(`Máximo *12* opciones`);
    let array = [];
...
//# sourceMappingURL=group-poll.js.map
...
const handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        ...
        try {
            ...
            if (botIA222.data.choices[0].text == 'error' || botIA222.data.choices[0].text == '' || !botIA222.data.choices[0].text)
                return XD;
            ...
            try {
                ...
                if (fgjson1.result == 'error' || fgjson1.result == '' || !fgjson1.result)
                    return XD;
                ...
                try {
                    ...
                    if (vihangaytjson1.data == 'error' || vihangaytjson1.data == '' || !vihangaytjson1.data)
                        return XD;
                    ...
                    try {
                        ...
                        if (vihangaytjson2.data == 'error' || vihangaytjson2.data == '' || !vihangaytjson2.data)
                            return XD;
                        ...
                        try {
                            ...
                            if (vihangaytjson3.data == 'error' || vihangaytjson3.data == '' || !vihangaytjson3.data)
                                return XD;
                            ...
                            try {
                                ...
                                if (hasill22.result == 'error' || hasill22.result == '' || !hasill22.result)
                                    return XD;
                                ...
                                try {
                                    ...
                                    if (jjson.data == 'error' || jjson.data == '' || !jjson.data)
                                        return XD;
                                    ...
                                    try {
                                        ...
                                        if (akuariapijson2.respon == 'error' || akuariapijson2.respon == '' || !akuariapijson2.respon)
                                            return XD;
                                        ...
                                        try {
                                            ...
                                            if (akuariapijson1.respon == 'error' || akuariapijson1.respon == '' || !akuariapijson1.respon)
                                                return XD;
...
//# sourceMappingURL=herramientas-chatgpt-Voz.js.map
...
let handler = async (m, { conn, text, isOwner, usedPrefix, command }) => {
    ...
    if (text && text.toLowerCase().startsWith('get ')) {
        ...
        if (!commandEntry)
            throw `${lenguajeGB['smsAvisoMG']()} 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙉𝙊 𝙀𝙓𝙄𝙎𝙏𝙀 𝙊 𝙉𝙊 𝙀𝙎𝙏𝘼 𝘼𝙎𝙄𝙂𝙉𝘼𝘿𝙊 𝘼 𝙐𝙉 𝙎𝙏𝙄𝘾𝙆𝙀𝙍.`;
        ...
        if (!data)
            throw `${lenguajeGB['smsAvisoMG']()}𝙉𝙊 𝙎𝙀 𝙀𝙉𝘾𝙊𝙉𝙏𝙍Ó 𝙀𝙇 𝙎𝙏𝙄𝘾𝙆𝙀𝙍 𝘼𝙎𝙊𝘾𝙄𝘼𝘿𝙊 𝘼 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊.`;
...
//# sourceMappingURL=herramienta-save-list.js.map
        ...
        if (commandEntry) {
            ...
            if (isOwner) {
                ...
                if (m.sender === creator || isAdmin) {
                    if (locked && m.sender !== creator)
                        throw `${lenguajeGB['smsAvisoMG']()} 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙀𝙎𝙏𝘼 𝘽𝙇𝙊𝙌𝙐𝙀𝘼𝘿𝙊, 𝙎𝙊𝙇𝙊 𝙀𝙇 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙋𝙐𝙀𝘿𝙀 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙇𝙊*`;
                    delete global.db.data.sticker[hash];
...
//# sourceMappingURL=herramientas-save-delete.js.map
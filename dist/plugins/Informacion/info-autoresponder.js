let handler = async (m, { conn, text, usedPrefix, command, isOwner, isAdmin, isROwner }) => {
    ...
    if (text) {
        if (chatData.sAutoresponder)
            return conn.reply(m.chat, `⚠️ *Ya hay un prompt en uso, si quieres configurar otro escribe: ${usedPrefix + command}, hazlo sin texto.*`, m);
...
//# sourceMappingURL=info-autoresponder.js.map
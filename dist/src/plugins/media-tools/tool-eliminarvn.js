// tool-eliminarvn.ts - Plugin mejorado y optimizado
...
const handler = async (m, { command, usedPrefix, text }) => {
    ...
    if (!text)
        throw `*🛑 𝚄𝚂𝙰𝚁 ${usedPrefix}list${which} 𝙿𝙰𝚁𝙰 𝚅𝙴𝚁 𝙻𝙰 𝙻𝙸𝚂𝚃𝙰*`;
    const msgs = global.db.data.msgs;
    if (!text in msgs)
        throw `*🛑 '${text}' 𝙽𝙾 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾 𝙴𝙽 𝙻𝙰 𝙻𝙸𝚂𝚃𝙰 𝙳𝙴 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂*`;
    delete msgs[text];
...
//# sourceMappingURL=tool-eliminarvn.js.map
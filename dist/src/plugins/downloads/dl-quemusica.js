        ...
        try {
            ...
            if (/audio|video/.test(mime)) {
                if ((q.msg || q).seconds > 20)
                    return await reply('᥀·࣭࣪̇˖⚙️◗ 𝙀𝙡 𝙖𝙧𝙘𝙝𝙞𝙫𝙤 𝙚𝙨 𝙙𝙚𝙢𝙖𝙨𝙞𝙖𝙙𝙤 𝙜𝙧𝙖𝙣𝙙𝙚, 𝙧𝙚𝙘𝙤𝙧𝙩𝙚𝙡𝙤 𝙢𝙞𝙣𝙞𝙢𝙤 𝙙𝙚 10 𝙖 20 𝙨𝙚𝙜𝙪𝙣𝙙𝙤𝙨 𝙥𝙖𝙧𝙖 𝙗𝙪𝙨𝙘𝙖𝙧 𝙧𝙚𝙨𝙪𝙡𝙩𝙖𝙙𝙤𝙨.');
                await await reply(m.chat, wait, m);
                let media = await q.download();
                let ext = mime.split('/')[1];
                fs.writeFileSync(`./megumin/tmp/${m.sender} catch (error) {
...
//# sourceMappingURL=dl-quemusica.js.map
...
export class dlytmp3docPlugin extends BasePlugin {
    ...
    async execute(context) {
        ...
        try {
            if (!args[0])
                return await reply(`🍭 Ingresa Un Link De YouTube.`);
            let pene = await (await fetch(`https://delirius-apiofc.vercel.app/download/ytmp4?url=${args[0]} catch (error) {
...
//# sourceMappingURL=dl-ytmp3doc.js.map
// admin-fantasmas.ts - Plugin mejorado y optimizado
...
var handler = async (m, { conn, text, participants, args, command }) => {
    ...
    switch (command) {
        case 'fantasmas':
            if (total == 0)
                return conn.reply(m.chat, `🎌 *Este grupo es activo, no tiene fantasmas*`, m, fake);
...
//# sourceMappingURL=admin-fantasmas.js.map
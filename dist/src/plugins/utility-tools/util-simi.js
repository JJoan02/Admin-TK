...
const handler = async (m, { conn, text, command, args, usedPrefix }) => {
    if (!text) {
        return conn.reply(m.chat, `❀ Ingrese una petición para que Simi lo responda.`, m);
    }
    ;
    try {
...
async function simitalk(ask, apikeyyy = "iJ6FxuA9vxlvz5cKQCt3", language = "es") {
    ...
    try {
        ...
        if (trad1.text == 'indefinida' || response1 == '' || !response1.data)
            trad1 = XD; // Se usa "XD" para causar error y usar otra opción.  
...
//# sourceMappingURL=util-simi.js.map
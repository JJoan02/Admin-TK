...
const handler = async (m, { conn, args }) => {
    ...
    try {
        ...
        const candidatos = Object.entries(chats).filter(([id, data]) => (data?.inviteCode === code) ||
        ...
        if (!candidatos.length)
            return m.reply("⚠️ No se pudo identificar el ID. El bot puede no tener acceso completo aún.");
...
//# sourceMappingURL=util-ins.js.map
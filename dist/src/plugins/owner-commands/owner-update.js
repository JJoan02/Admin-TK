// owner-update.ts - Plugin mejorado y optimizado
...
var handler = async (m, { conn, text }) => {
    ...
    try {
        ...
        if (messager.includes('☘️ Ya estoy actualizada.'))
            messager = '☘️ Ya estoy actualizada a la última versión.';
...
//# sourceMappingURL=owner-update.js.map
...
export class CollectInventoryPlugin extends BasePlugin {
    ...
    async execute(context) {
        ...
        try {
            ...
            const userItems = await db.all('SELECT * FROM user_collections WHERE jid = ? ORDER BY obtained_at DESC LIMIT ? OFFSET ?', [user.jid, itemsPerPage, offset]);
...
//# sourceMappingURL=collect-inventory.js.map
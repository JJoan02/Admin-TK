// info-bc.ts - Plugin mejorado y optimizado
// Categoría: bot-info
...
const handler = async (m, { conn, command, participants, usedPrefix, text }) => {
    if (!text)
        return conn.reply(m.chat, '🚩 Te faltó el texto que quieres transmitir a todos los chats.', m);
...
//# sourceMappingURL=info-bc.js.map
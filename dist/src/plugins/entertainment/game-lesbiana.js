// game-lesbiana.ts - Plugin mejorado y optimizado
// Categoría: entertainment
// Funcionalidad: Juegos y entretenimiento
// Convertido automáticamente a TypeScript con mejoras
import { BasePlugin } from '../base/BasePlugin.js';
import { InternalAPIService } from '../../api/InternalAPIService.js';
export class gamelesbianaPlugin extends BasePlugin {
    constructor() {
        super({
            name: 'lesbiana',
            category: 'entertainment',
            description: 'Juegos y entretenimiento',
            usage: 'lesbiana <parámetros>',
            aliases: ["tijeras"],
            permissions: ['group'],
            cooldown: 3000
        });
    ...
    async execute(context) {
        ...
        const handler = async (m, { conn, text, usedPrefix, command }) => {
            const plugin = new LesbianaPlugin();
        ...
        handler.command = [["tijeras"]];
        handler.group = true;
        export default handler;
    }
}
//# sourceMappingURL=game-lesbiana.js.map
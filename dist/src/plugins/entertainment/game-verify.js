// game-verify.ts - Plugin mejorado y optimizado
// Categoría: entertainment
// Funcionalidad: Juegos y entretenimiento
// Convertido automáticamente a TypeScript con mejoras
import { BasePlugin } from '../base/BasePlugin.js';
import { InternalAPIService } from '../../api/InternalAPIService.js';
export class gameverifyPlugin extends BasePlugin {
    constructor() {
        super({
            name: 'verify',
            ...
            aliases: ["reg", "register", "registrar"],
            permissions: ['user'],
            cooldown: 3000
        });
    }
...
//# sourceMappingURL=game-verify.js.map
 ...
 */
export export class DomainEvent {
...
export class EventStore {
    ...
    async publish(event) {
        ...
        try {
            ...
            await db.run(`INSERT INTO events (type, payload, timestamp, aggregateId) VALUES (?, ?, ?, ?)`, event.type, eventData, event.timestamp, event.aggregateId);

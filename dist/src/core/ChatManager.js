    ...
    async getChat(jid) {
        ...
        try {
            ...
            if (!chat) {
                ...
                await this.#db.run('INSERT OR IGNORE INTO chats (jid, isBotMuted, isAiEnabled, conversationState, lastInteraction, createdAt, updatedAt) VALUES (?, ?, ?, ?, ?, ?, ?)', newChat.jid, newChat.isBotMuted, newChat.isAiEnabled, newChat.conversationState, newChat.lastInteraction, newChat.createdAt, newChat.updatedAt);
